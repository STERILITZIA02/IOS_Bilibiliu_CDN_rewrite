...
- Use: public JSON and Protobuf field meanings for the VIP center, ViewProgress,
  video-guide, playback-operation containers, Mine PubModule, Popular cards,
  and current playback services were inspected only as interoperability facts.
  No documentation text, example data, schema, or generated implementation is
  incorporated.
...
- License: GNU General Public License v3.0
- Use: current Shadowrocket/Surge endpoint coverage for ViewProgress, Mine,
  resource/activity, live-shopping, game-material, and VIP ad-material
  responses was cross-checked. No module, script, or jq implementation was
  incorporated.
